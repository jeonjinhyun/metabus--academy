package com.ohgiraffers.section01.scope.subsection.singleton01;
...
public class Application {
    public static void main(String[] args) {
        ...
        * session : HTTP 세션당 하나의 인스턴스를 생성하고, 세션이 종료되면 인스턴스를 폐기한다.(웹 어플리케이션 컨텍스트만 해당)
        * globalsession : 전역 세션당 하나의 인스턴스를 생성하고, 전역세션이 종료되면 인스턴스를 폐기한다.(포털 어플리케이션 컨텍스트만 해당)
        * */
