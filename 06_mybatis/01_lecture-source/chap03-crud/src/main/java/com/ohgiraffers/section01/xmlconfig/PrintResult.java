...
public class PrintResult {
    ...
    public void printErrorMessage(String msg){
        ...
        switch (msg){
            ...
            case "findOne" : errorMessage = "메뉴 상세 조회를 실패하였습니다.";break;
            case "insert" : errorMessage = "신규 메뉴 등록에 실패하셨습니다."; break;
            case "modify" : errorMessage = "메뉴 수정에 실패하셨습니다.";break;
            case "remove" : errorMessage = "메뉴 삭제에 실패하셨습니다.";break;
        }
    ...
    public void printSuccessMessage(String msg) {
        ...
        switch (msg){
            ...
            case "remove": successMessage="메뉴 삭제에 성공하셨습니다!";break;
        }
